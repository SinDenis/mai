...
void Insert(TQueue<TRhombus<int>, TAllocator<TRhombus<int>, BLOCK_SIZE> >& q)
{
...
void Remove(TQueue<TRhombus<int>, TAllocator<TRhombus<int>, BLOCK_SIZE> >& q)
{
	int64_t idx;
...
void Count(TQueue<TRhombus<int>, TAllocator<TRhombus<int>, BLOCK_SIZE> >& q)
{
	int square;
	std::cin >> square;
